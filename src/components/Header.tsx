            ...
            <div className="hidden lg:flex items-center gap-2 xl:gap-4">
              ...
              {profile ? (
                <Link 
                  ...
                  className="w-10 h-10 xl:w-12 xl:h-12 rounded-full bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center overflow-hidden border-2 border-transparent hover:border-primary transition-all"
                >
                  {profile.avatar ? (
